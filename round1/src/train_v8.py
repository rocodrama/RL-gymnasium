...
class TrainConfig:
    ...
    model_path: str = "round8_adaptive_reheat.pkl"
...
def get_candidate_indices(state):
    ...
    # Until all 5 colors are collected, allow swap attempt even before first use.
                ...
                if self.sword == 0:
                    ...
                    if not self.current_sword_used and not can_force_swap_new_color:
                        ...
                        if can_force_swap_new_color:
                            # Soft exception: keep "use before swap" as default,
                            # but allow unseen-color swap to prevent 3-color lock-in.
    ...
    for episode in range(1, config.episodes + 1):
        ...
        while steps < config.max_steps and not done:
            ...
            if moved and old_dist >= 0 and new_dist >= 0:
                ...
                # In full-focus stage (5 colors), suppress goal beeline
                # until all sword colors are collected.
                if (
