...
SWORD_COLOR_DISCOVERY_BONUS = 26.0
UNSEEN_SWORD_PROGRESS_GAIN = 0.35
UNSEEN_SWORD_RETREAT_PENALTY = 0.20
    ...
    for episode in range(1, config.episodes + 1):
        ...
        while steps < config.max_steps and not done:
            ...
            if next_sword_color_num > sword_color_num:
                reward += SWORD_COLOR_DISCOVERY_BONUS * (next_sword_color_num - sword_color_num)
